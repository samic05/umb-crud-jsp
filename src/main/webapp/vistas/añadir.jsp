<%-- 
    Document   : añadir
    Created on : Aug 14, 2020, 1:06:09 PM
    Author     : samic
--%>
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="crud-app?action=add">Añadir</a></li>
            </ul>
    ...
    <div class="row content">
        ...
        <div class="col-sm-8 text-left">
            ...
            <form action="crud-app">
                ...
                <input type="text" class="form-control" name="docNum"> <br>
                Nombre(s): <br>
                <input type="text" class="form-control" name="name"> <br>
                Apellido: <br>
                <input type="text" class="form-control" name="lastName"> <br>
                Departamento: <br>
                <input type="text" class="form-control" name="department"> <br><br>
                <button type="submit" name="action" class="btn btn-success" value="addNew">Agregar Empleado</button>
